...
return [
    ...
    */
    ...
    'from' => [
        'address' => env('MAIL_FROM_ADDRESS', 'noreply@securelicence.com'),
        'name' => env('MAIL_FROM_NAME', 'Secure Licence'),
    ],
    ...
    | lives at resources/views/vendor/mail/html/themes/securelicence.css.
    |
    */
