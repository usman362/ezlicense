...
@section('heading', 'Industry Insight Categories')
        ...
        <div class="card border-0 shadow-sm">
            ...
            <div class="card-body">
                <div class="mb-3">
                    ...
                    <input type="text" id="cat-name" class="form-control" placeholder="e.g. Market Trends">
                </div>
    ...
    <div class="col-lg-7">
        <div class="card border-0 shadow-sm">
            <div class="card-header bg-white py-3 d-flex justify-content-between align-items-center">
                ...
                <a href="{{ route('admin.industry-insights.index') }}" class="btn btn-sm btn-outline-secondary"><i class="bi bi-arrow-left me-1"></i>Back to Insights</a>
            </div>
            <div class="table-responsive">
                <table class="table table-hover align-middle mb-0">
                    <thead class="table-light">
                        <tr><th>Name</th><th>Slug</th><th>Insights</th><th style="width:130px">Actions</th></tr>
                    </thead>
                    <tbody id="cat-tbody">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function loadCategories() {
        fetch('/api/admin/industry-insights/categories/list').then(r => r.json()).then(data => {
    ...
    document.getElementById('update-cat-btn').addEventListener('click', () => {
        ...
        if (!name) return;
        fetch(`/api/admin/industry-insights/categories/${id}`, {
    ...
    document.getElementById('cat-tbody').addEventListener('click', (e) => {
        ...
        if (btn && confirm(`Delete category "${btn.dataset.name}"?`)) {
            fetch(`/api/admin/industry-insights/categories/${btn.dataset.id}`, {
