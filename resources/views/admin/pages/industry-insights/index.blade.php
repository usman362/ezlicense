...
<div class="d-flex flex-wrap justify-content-between align-items-center mb-4 gap-2">
    <div class="d-flex gap-2 align-items-center flex-wrap">
        <div class="input-group" style="max-width:260px;">
            ...
            <input type="text" id="search-input" class="form-control" placeholder="Search insights...">
        </div>
    ...
    <div class="d-flex gap-2">
        <a href="{{ route('admin.industry-insights.categories') }}" class="btn btn-outline-secondary"><i class="bi bi-tags me-1"></i>Categories</a>
        <a href="{{ route('admin.industry-insights.create') }}" class="btn btn-primary"><i class="bi bi-plus-lg me-1"></i>New Insight</a>
    </div>
</div>
...
<div class="modal fade" id="delete-modal" tabindex="-1"><div class="modal-dialog modal-sm"><div class="modal-content">
    <div class="modal-header"><h6 class="modal-title">Delete Insight</h6><button type="button" class="btn-close" data-bs-dismiss="modal"></button></div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    fetch('/api/admin/industry-insights/categories/list')
        .then(r => r.json())
        .then(data => {
    ...
    function loadPosts(page) {
        ...
        let url = `/api/admin/industry-insights/list?page=${currentPage}`;
        ...
        fetch(url).then(r => r.json()).then(data => {
            ...
            if (!data.posts || data.posts.length === 0) {
                tbody.innerHTML = '<tr><td colspan="8" class="text-center py-4 text-muted">No insights found.</td></tr>';
            ...
            tbody.innerHTML = data.posts.map(p => `
                <tr>
                    ...
                    <td>
                        ...
                        <br><small class="text-muted">/industry-insights/${p.slug}</small>
                    </td>
                    ...
                    <td>
                        <div class="d-flex gap-1">
                            <a href="/admin/industry-insights/${p.id}/edit" class="btn btn-sm btn-outline-primary" title="Edit"><i class="bi bi-pencil"></i></a>
            ...
            document.getElementById('pagination-info').textContent = `Showing page ${data.current_page} of ${data.last_page} (${data.total} insights)`;
    ...
    document.getElementById('posts-tbody').addEventListener('click', (e) => {
        ...
        if (btn) {
            fetch(`/api/admin/industry-insights/${btn.dataset.id}/toggle-featured`, {
    ...
    document.getElementById('confirm-delete-btn').addEventListener('click', () => {
        if (!deleteId) return;
        fetch(`/api/admin/industry-insights/${deleteId}`, {
