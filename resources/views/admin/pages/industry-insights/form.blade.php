...
@section('title', $post ? 'Edit Insight' : 'New Insight')
@section('heading', $post ? 'Edit Insight' : 'New Industry Insight')

@section('content')
<form action="{{ $post ? route('admin.industry-insights.update', $post) : route('admin.industry-insights.store') }}" method="POST" enctype="multipart/form-data" id="insight-form">
    @csrf
            ...
            <div class="card border-0 shadow-sm mb-4">
                <div class="card-body">
                    <div class="mb-3">
                        ...
                        <small class="text-muted" id="slug-preview">{{ $post ? 'Slug: /industry-insights/' . $post->slug : '' }}</small>
                    </div>
            ...
            <div class="card border-0 shadow-sm mb-4">
                ...
                <div class="card-body">
                    ...
                    <div class="form-check mb-3">
                        ...
                        <label class="form-check-label" for="is-featured">Featured Insight</label>
                    </div>
                </div>
                <div class="card-footer bg-white d-flex gap-2">
                    <a href="{{ route('admin.industry-insights.index') }}" class="btn btn-outline-secondary flex-fill">Cancel</a>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    titleInput.addEventListener('input', () => {
        ...
        slugPreview.textContent = slug ? 'Slug: /industry-insights/' + slug : '';
    });
    @endif
    ...
    document.getElementById('add-cat-btn').addEventListener('click', () => {
        ...
        if (!name) return;
        fetch('/api/admin/industry-insights/categories', {
            method: 'POST',
