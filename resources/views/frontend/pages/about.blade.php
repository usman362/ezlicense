...
<section class="py-5">
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-8">
                <h1 class="display-6 fw-bold mb-4" style="color: var(--ez-dark);">About Secure Licences</h1>
                <p class="lead mb-4">Secure Licences is Australia's leading online platform for booking driving lessons and connecting learner drivers with verified, independent driving instructors.</p>
                <h2 class="h4 fw-bold mt-5 mb-3">Our Mission</h2>
                <p>We believe that learning to drive should be simple, transparent, and accessible. Secure Licences takes the hassle out of choosing a driving school by giving learners the tools to find, compare, and book verified driving instructors online — all in one place.</p>
                <h2 class="h4 fw-bold mt-5 mb-3">What We Do</h2>
                <p>Unlike a traditional driving school, Secure Licences is a marketplace that connects learners directly with qualified, independent driving instructors across Australia. Our platform offers real-time availability, transparent pricing, genuine learner reviews, and instant online booking — 24 hours a day, 7 days a week.</p>
                <h2 class="h4 fw-bold mt-5 mb-3">Why Choose Secure Licences?</h2>
                ...
                <p>Secure Licences also provides driving instructors with a powerful platform to grow their business. With automated scheduling, online payments, and access to thousands of learners, instructors can focus on what they do best — teaching people to drive safely.</p>
