        ...
        <div class="row justify-content-center">
            <div class="col-lg-9">
                ...
                <div class="mb-4">
                    ...
                    <p>Secure Licence is committed to protecting your privacy. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you use our website and services. We comply with the Australian Privacy Principles (APPs) contained in the Privacy Act 1988 (Cth).</p>
                </div>
                ...
                <div class="mb-4">
                    ...
                    <ul class="list-unstyled ms-3">
                        <li><strong>Email:</strong> privacy@securelicence.com</li>
                        <li><strong>Web:</strong> <a href="{{ url('/contact') }}">Contact page</a></li>
                        <li><strong>Post:</strong> Secure Licence Privacy Officer, Sydney, NSW, Australia</li>
                    </ul>
                </div>
            </div>
        </div>
