...
class SiteSetting extends Model
{
    ...
    */
    ...
    public static function seedDefaults(): void
    {
        $defaults = [
            // General
            ['group' => 'general', 'key' => 'site_name', 'value' => 'Secure Licence', 'type' => 'text', 'label' => 'Site Name', 'hint' => 'The name displayed across the platform'],
            ...
            ['group' => 'general', 'key' => 'support_email', 'value' => 'support@securelicence.com', 'type' => 'text', 'label' => 'Support Email', 'hint' => 'Displayed in footer and emails'],
            ...
            ['group' => 'general', 'key' => 'instagram_url', 'value' => 'https://www.instagram.com/securelicence', 'type' => 'text', 'label' => 'Instagram URL', 'hint' => 'Instagram profile URL for emails and footer'],
            ['group' => 'general', 'key' => 'admin_notification_email', 'value' => 'admin@securelicence.com', 'type' => 'text', 'label' => 'Admin Notification Email', 'hint' => 'Email address that receives booking alerts (new, cancel, complete)'],
            ...
            // Email
            ['group' => 'email', 'key' => 'mail_from_name', 'value' => 'Secure Licence', 'type' => 'text', 'label' => 'From Name', 'hint' => 'Sender name in outgoing emails'],
            ['group' => 'email', 'key' => 'mail_from_address', 'value' => 'noreply@securelicence.com', 'type' => 'text', 'label' => 'From Address', 'hint' => 'Sender email address'],
            ...
            ['group' => 'seo', 'key' => 'seo_default_title',        'value' => 'Secure Licence — Find a verified driving instructor near you', 'type' => 'text',     'label' => 'Default Page Title',        'hint' => 'Used as the <title> when a page does not set its own. Keep under ~60 characters.'],
            ['group' => 'seo', 'key' => 'seo_title_suffix',         'value' => ' | Secure Licence',                                              'type' => 'text',     'label' => 'Title Suffix',              'hint' => 'Appended to every page title (e.g. " | Secure Licence"). Leave blank to disable.'],
            ...
            ['group' => 'seo', 'key' => 'seo_twitter_handle',       'value' => '@securelicence',                                                  'type' => 'text',     'label' => 'Twitter / X Handle',        'hint' => 'Including the @ sign — used in Twitter Card meta tags.'],
            ['group' => 'seo', 'key' => 'seo_canonical_host',       'value' => '',                                                                'type' => 'text',     'label' => 'Canonical Host',            'hint' => 'Optional. e.g. "https://www.securelicence.com" — used to build canonical URLs. Leave blank to use request URL.'],
